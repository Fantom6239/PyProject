...
# К вещественным числам относятся все рациональные, а также бесконечные дроби. С клавиатуры можно ввести лишь константы, которые были добавлены в массив ранее
vesh.extend(raz)
